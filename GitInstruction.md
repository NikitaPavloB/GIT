<img src="Git-Logo-1788C.png" alt="logotip_git" width="200"/>
...
cd <name>
```
Данная команда выполняет переход в папку которая нам нужна
```
cd ..
```
Команда переносит нас в исходную папку (корневую)
* ### **Различные способы применения команды "git remote"** 
```
git remote
```
...
* ### **Различные способы применения команды "git fetch"**
```
git fetch <remote>
```
...
* ### **Различные способы применения команды "git push"**
```
git push
```
...
* ### **Различные способы применения команды "git pull"**
```
git pull <remote>
```
